...
extension MediaQueryExtension on BuildContext {
  ...
  double get sValue => height * 0.005;
  double get lowValue => height * 0.025;
  double get normalValue => height * 0.035;
  double get mediumValue => height * 0.05;
  double get largeValue => height * 0.1;
  double get highValue => height * 0.18;
  double get xLargeValue => height * 0.29;
  double get xxLargeValue => height * 1;
...
extension PaddingExtension on BuildContext {
  ...
  EdgeInsets get verticalPaddingHigh =>
      EdgeInsets.symmetric(vertical: largeValue);
...
extension BorderExtension on BuildContext {
  ...
  RoundedRectangleBorder get roundedRectangleBorderNormal =>
      RoundedRectangleBorder(
        borderRadius: BorderRadius.vertical(
          top: Radius.circular(normalValue),
        ),
      );
  ...
  RoundedRectangleBorder get roundedRectangleBorderMedium =>
      RoundedRectangleBorder(
        borderRadius: BorderRadius.vertical(
          top: Radius.circular(mediumValue),
        ),
      );
